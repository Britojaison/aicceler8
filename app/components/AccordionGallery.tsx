...
const AccordionGallery: React.FC<AccordionGalleryProps> = ({
  ...
  const active = controlledActiveIndex !== undefined ? controlledActiveIndex : internalActive;
  ...
  const setActive = useCallback(
    ...
    [controlledActiveIndex, onActiveChange]
  );
      ...
      {items.map((item, i) => {
        ...
        return (
          <Tag
            ...
            style={{ borderRadius: `${radius}px`, backgroundColor: item.bgColor || undefined }}
            ...
            aria-label={item.label || item.title || `Panel ${i + 1}`}
          >
